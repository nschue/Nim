...
public class DatabaseHelperMedium extends SQLiteOpenHelper {
    public static final String PLAYER_DATABASE = "medium.db";
    public static final String TABLE_NAME = "medium_table";
    public static final String COL_ID = "ID";
    public static final String COL_NAME = "NAME";
    public static final String COL_SCORE = "SCORE";


    public DatabaseHelperMedium(Context context) {
        super(context, PLAYER_DATABASE, null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT,NAME TEXT,SCORE DOUBLE)");
    }
